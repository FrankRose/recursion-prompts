...
var countValuesInObj = function(obj, value) {
  ...
  for (let key in obj) {
    ...
    count +=
      typeof obj[key] === 'object' ? countValuesInObj(obj[key], value) : 0;
  }
...
var nestedEvenSum = function(obj) {
  ...
  for (let key in obj) {
    sum += typeof obj[key] === 'number' && obj[key] % 2 === 0 ? obj[key] : 0;
    sum += typeof obj[key] === 'object' ? nestedEvenSum(obj[key]) : 0;
  }
...
var compress = function(list) {
  ...
  return output.concat(compress(list.slice(index)));
};
...
var augmentElements = function(array, aug) {
  ...
  return array.slice(0, 1).concat(augmentElements(array.slice(1), aug));
};
...
var alternateSign = function(array) {
  ...
  if (array.length === 2) {
    array[0] = array[0] < 0 ? 0 - array[0] : array[0];
    array[1] = array[1] > 0 ? 0 - array[1] : array[1];
